...
def cover_letter():
    ...
    print("My name is ",name," and I am a Software Engineer with more than ",experience, " of experience as "+software_role+"."+"During my previous employment with "+prev_org+", I have worked on several tools and technologies like"+t_and_t+" and some databases experience of "+databases,".\n")
