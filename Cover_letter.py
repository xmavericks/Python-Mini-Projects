...
def cover_letter():
    ...
    print("As I can see that you are looking for a person who has some working experience in"+software_role+"and have some working knowledge of databases like, "+databases)
